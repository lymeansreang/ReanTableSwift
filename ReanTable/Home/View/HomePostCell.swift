...
class HomePostCell: UITableViewCell {
    ...
    private lazy var likeButton = initButton(title: "Like", icon: "likeEmoji")
    private lazy var commentButton = initButton(title: "Comment", icon: "happyEmoji")
    private lazy var sendButton = initButton(title: "Send", icon: "happyEmoji")
    private lazy var shareButton = initButton(title: "Share", icon: "happyEmoji")
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
            ...
            reactionStackView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor),
